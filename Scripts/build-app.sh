...
cp "$STAR_MEMO_ROOT/Sources/StarMemoUI/Resources/StarMemo.icns" "$STAR_MEMO_APP/Contents/Resources/StarMemo.icns"
cp "$STAR_MEMO_ROOT/LICENSE" "$STAR_MEMO_APP/Contents/Resources/LICENSE"
...
test -s "$STAR_MEMO_APP/Contents/Resources/LICENSE"
bash "$STAR_MEMO_ROOT/Scripts/check-app-icon.sh" "$STAR_MEMO_APP"
