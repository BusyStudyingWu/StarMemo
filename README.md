...
当前版本：**0.1.6（Build 7）**。仓库目前为私有，Release 下载需要仓库访问权限。

## 下载与安装

在 [GitHub Releases](https://github.com/BusyStudyingWu/StarMemo/releases) 下载
`StarMemo-0.1.6-macOS-arm64.dmg`，打开后将 `StarMemo.app` 拖入“应用程序”。
...
2026-09-14 验证：核心检查 29 项、UI 完整复跑 101 项通过，0.1.6 Release 配置构建成功。首轮有一项原生空白区点击焦点检查失败，完整复跑通过，仍需留意桌面焦点相关测试稳定性。
