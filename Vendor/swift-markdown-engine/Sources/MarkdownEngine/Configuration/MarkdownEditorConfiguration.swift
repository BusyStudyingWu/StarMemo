...
public struct CheckboxStyle: Sendable {
    ...
    /// Outline width used for an unchecked task checkbox.
    public var uncheckedStrokeWidth: CGFloat
    ...
    public init(
        ...
        uncheckedStrokeWidth: CGFloat = 1.0
    ) {
        ...
        self.uncheckedStrokeWidth = uncheckedStrokeWidth
    }
