...
public struct LatexRenderResult: @unchecked Sendable {
...
public struct MarkdownEditorBus: Sendable {
    ...
    /// Posted by the host UI to request strikethrough styling.
    public var applyStrikethroughRequest: Notification.Name?
    /// Posted by the host UI to request inline-code styling.
    public var applyInlineCodeRequest: Notification.Name?
    /// Posted by the host UI to request Markdown link styling.
